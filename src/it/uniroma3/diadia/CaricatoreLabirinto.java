...
public class CaricatoreLabirinto {
 ...
 private void leggiECollocaAttrezzi() throws FormatoFileNonValidoException {
  ...
  for(String specificaAttrezzo : separaStringheAlleVirgole(specificheAttrezzi)) {
   ...
   try (Scanner scannerLinea = new Scanner(specificaAttrezzo)) {
    ...
    this.check(scannerLinea.hasNext(),this.msgTerminazionePrecoce("il peso dell'attrezzo "+nomeAttrezzo+"."));    
    pesoAttrezzo =scannerLinea.next();
    this.check(scannerLinea.hasNext(),this.msgTerminazionePrecoce("il nome della stanza in cui collocare l'attrezzo "+nomeAttrezzo+"."));
 ...
 private void posaAttrezzo(String nomeAttrezzo, String pesoAttrezzo, String nomeStanza) throws FormatoFileNonValidoException {
  ...
  try {
   ...
   this.check(this.isStanzaValida(nomeStanza),"Attrezzo "+ nomeAttrezzo+" non collocabile: stanza " +nomeStanza+" inesistente");
 ...
 for(String specifiche: this.separaStringheAlleVirgole(specificheUscite)) {
    try (Scanner scannerDiLinea = new Scanner(specifiche)) {   
        ...
        while (scannerDiLinea.hasNext()) {
             ...
             this.check(scannerDiLinea.hasNext(),this.msgTerminazionePrecoce("la direzione di una uscita della stanza "+stanzaPartenza));
              String dir = scannerDiLinea.next();
             this.check(scannerDiLinea.hasNext(),this.msgTerminazionePrecoce("la destinazione di una uscita della stanza "+stanzaPartenza+" nella direzione "+dir));
 ...
 private void impostaUscita(String stanzaDa, String dir, String nomeA) throws FormatoFileNonValidoException {
  this.check(isStanzaValida(stanzaDa),"Stanza di partenza sconosciuta "+dir);
  this.check(isStanzaValida(nomeA),"Stanza di destinazione sconosciuta "+ dir);
